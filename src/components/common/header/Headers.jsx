...
//             </button>
//           </div>
//           <div className="sm:flex-wrap flex justify-end lg:order-2 ">
    ...
    <header className="fixed top-0 w-full bg-white z-30 shadow">
      <nav className="border-gray-200 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center max-w-screen-2xl mx-auto px-4">
          ...
          <div className="flex items-center space-x-3 lg:order-2 w-auto">
            <div className="flex items-center bg-[#F0F2F5] rounded px-2 py-1.5 sm:px-3 sm:py-2 whitespace-nowrap">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width={24}
                height={24}
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="w-4 h-4 sm:w-5 sm:h-5 text-[#121417] mr-1"
              >
                <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" />
                <circle cx={12} cy={7} r={4} />
              </svg>
              <span className="font-medium glow-text text-[#121417] text-sm sm:text-base">
                Super Admin
              </span>
            </div>

            <div className="flex items-center bg-gray-800 rounded px-2 py-1.5 sm:px-3 sm:py-2 whitespace-nowrap">
              <Wallet className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-500 mr-1 sm:mr-2" />
              <span className="font-medium glow-text text-yellow-500 text-sm sm:text-base">
                {data && currencyFormator(parseInt(data?.data.balance))} INR
              </span>
            </div>
          </div>
