...
//         <>
//             <div
//                 className="relative flex min-h-screen flex-col bg-[#f8fafb] group/design-root overflow-x-hidden"
//             >
...
//                                 <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 flex-1 bg-[#1f93e0] text-[#f8fafb] text-sm font-bold leading-normal tracking-[0.015em]">
...
import loginValidationSchema from '../../../validation/loginValidator';
...
<<<<<<< HEAD
        ...
        onSubmit: async (values, { setSubmitting }) => {
            try {
                await dispatch(login(values)).unwrap(); // Wait for the login action to complete
            } catch (error) {
