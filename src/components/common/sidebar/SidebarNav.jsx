...
const SidebarNav = ({ isOpen, setIsOpen }) => {
  return (
    <>
      ...
      <div
        className={`pointer-events-none z-10 layout-content-container flex-col w-full py-14 lg:flex shadow fixed top-0 h-full ${
          isOpen ? null : "hidden"
        }`}
      >
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              <NavLink
                to={"/"}
                className={({ isActive }) =>
                  isActive ? `bg-[#F0F2F5] rounded-xl` : undefined
                }
              >
